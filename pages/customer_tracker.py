...
st.markdown("Select the tracker and customer below to generate a formatted spreadsheet.")
...
if tracker_type == "FCL":
    ...
    path = None  # AIR - add path if you have it
...
if path and os.path.exists(path):
    try:
        ...
        if consignee_col in df.columns:
            ...
            if st.button("Generate & Download", type="primary"):
                with st.spinner("Creating formatted file..."):
    ...
    st.error("Tracker file not found. Check path.")
